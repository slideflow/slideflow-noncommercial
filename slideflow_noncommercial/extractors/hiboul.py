...
class HibouLImageFeatures(torch.nn.Module):

    def __init__(self,device='cuda'):
        super().__init__()
        self._model = AutoModel.from_pretrained("histai/hibou-L", trust_remote_code=True)
...
class HibouLFeatures(TorchFeatureExtractor):
    """Hibou-L - a Foundational Vision Transformer for digital pathology pretrained
    on a 1.2B image private dataset using DINOv2 framework.
    
    Feature dimensions: 1024

    Hugging Face: https://huggingface.co/histai/hibou-L

    """
    tag = 'hiboul'
    license = """Apache 2.0. License available at https://github.com/histai/hibou-L"""
    citation = """
...
"""
    ...
    def __init__(self, device='cuda', **kwargs):
        ...
        self.device = torch_utils.get_device(device)
        self.model = HibouLImageFeatures(device=self.device)
    ...
    def dump_config(self):
        ...
        return self._dump_config(
            class_name='slideflow.model.extractors.hiboul.HibouLFeatures',
        )
