...
class UNI2Features(TorchFeatureExtractor):
    """UNI2 pretrained feature extractor.

    UNI 2 was trained on over 200 million pathology H&E and IHC images sampled from 350+ thousand diverse whole slide images. It is available on Hugging Face at hf-hub:MahmoodLab/UNI2-h.
    ...
    Hugging Face: https://huggingface.co/MahmoodLab/UNI2-h
...
"""
    ...
    def dump_config(self):
        ...
        return self._dump_config(
            class_name='slideflow.model.extractors.uni2.UNI2Features',
